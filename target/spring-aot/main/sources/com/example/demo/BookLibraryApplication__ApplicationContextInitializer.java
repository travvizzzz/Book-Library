 ...
 */
@Generated
public class BookLibraryApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new BookLibraryApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new BookLibraryApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
